...
public class Browser {
	...
	public static WebElement eleTopMenu;
	public static List<WebElement> elements;
	public static String MainWindowHandle;
	public static Boolean isObjectPresent = true;
	public static File tmpDir = null;
	static String BwrType = null;
	ChromeOptions options;

	public static void Open(String BrowserType) throws Exception {
	...
	public static void exitTestifBrowserNotOpened(String message) throws Exception {
	...
	public static void Open(String BrowserType, String Url) throws Exception {
		Open(BrowserType);
		driver.get(Url);
	...
	public static void CheckIfElmentIsPresentByXpath(String xpath) {
	...
	public static void switchToModalWindow() {
		try {
			Thread.sleep(2000);
	...
	public static void pressEscapeButton() throws Exception {
	...
	public static void InputDataEx(String SheetName, String objName, String objDesc, String VerifyData, String Data)
			throws Exception {
	...
	public static void InputData(String SheetName, int Row) throws Exception {
		int noOfCOl = 0;
		...
		try {
			noOfCOl = ExcelUtil.GetNumberOfColumn(xlsFileName, SheetName);
		} catch (Exception e) {
			e.printStackTrace();
		}
		...
		for (int i = 1; i < noOfCOl; i++) {
			try {
				objName = ExcelUtil.getCellData(xlsFileName, SheetName, 0, i);
				objDesc = ExcelUtil.getCellData(xlsFileName, SheetName, 1, i);
				Data = ExcelUtil.getCellData(xlsFileName, SheetName, Row - 1, i);
				VerifyData = ExcelUtil.getCellData(xlsFileName, SheetName, Row, i);
			} catch (Exception e) {
	...
	public static WebElement getWebElementWithoutWait(String objDesc) {
		if (!objDesc.isEmpty()) {
	...
	public static WebElement getWebElementWithTimeOut(String objDesc, int actTimeOut) throws Exception {
	...
	public static WebElement getWebElement(String objDesc) throws Exception {
		if (!objDesc.isEmpty()) {
			String[] arrObjDesc = objDesc.split("::");
			String strObjDesc = objDesc.substring(arrObjDesc[0].length() + 2);
			try {
	...
	public static List<WebElement> getChildWebElementsList(WebElement parentElement, String objDesc) throws Exception {
	...
	public static int getTableRowCount(String objDesc) throws Exception {
		WebElement tableElement = getWebElement(objDesc);
		List<WebElement> allRows = tableElement.findElements(By.tagName("tr"));
		return allRows.size();
	}

	public static String getTableColumnNames(String objDesc) throws Exception {
		WebElement tableElement = getWebElement(objDesc);
		return getTableColumnNamesByTableElement(tableElement);
	}

	public static String getTableColumnNamesByTableElement(WebElement tableElement) {
	...
	public static int getTableColumnCount(String objDesc, int rowNumber) throws Exception {
		WebElement tableElement = getWebElement(objDesc);
		List<WebElement> colRow = tableElement.findElements(By.xpath("//tbody//tr"));
		return colRow.size();
	}

	public static String GetRowDataWithTbody(String objDesc, int row) throws Exception {
		int rowiIterator = 0;
		if (!objDesc.isEmpty()) {
			String[] arrObjDesc = objDesc.split("::");
			String strObjDesc = objDesc.substring(arrObjDesc[0].length() + 2);
	...
	public static void clickOn(String ComponentName, String objName, String objDesc) throws Exception {
		WebElement element = Browser.getWebElement(objDesc);
		if (element.isEnabled()) {
			switch (Browser.BwrType) {
			case "IE":
				element.click();
	...
	public static void clickOnUsingEnterKey(String ComponentName, String objName, String objDesc) throws Exception {
		WebElement element = Browser.getWebElement(objDesc);
		if (element.isEnabled()) {
			element.sendKeys(Keys.ENTER);
			// Reporter.log("Clicked on "+ objName +"[" + objDesc + "] ");
	...
	public static String GetCellData(String objDesc, int row, int col) throws Exception {
		int rowiIterator = 0;
		WebElement tableElement = getWebElement(objDesc);
	...
	public static void ReleaseMouseFromTopMenu(WebElement el) throws InterruptedException {
		Thread.sleep(1000);
