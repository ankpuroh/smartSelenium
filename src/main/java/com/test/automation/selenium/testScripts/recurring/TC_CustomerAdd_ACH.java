...
public class TC_CustomerAdd_ACH {
...
public static WebDriver driver=Browser.driver;
	...
	public void ExecuteTest(String BrowserType, String strProgramDetails, String strTestEnvDetails) throws Exception 
	{
		try{
			...
			Recurring_CustomerAdd.run(8);
			Thread.sleep(2000);
			
			try{
			driver=Browser.driver;
			txtCustNo = driver.findElement(By.id("customerNumber")).getAttribute("value");
			ExcelUtil.storeCellData("Recurring_CustomerAdd", "text::"+txtCustNo, 22, 68);
			Thread.sleep(2000);
			}
			catch(Exception e){
			...
			delCustomerSQL = "delete from edgepay_gateway_db.edgepay_recurring_customer where edgepay_recurring_customer_number = '2311' and edgepay_recurring_customer_merchant_id = '271105091008'";
